...
//let mult3 = [];
//let mult5 = [];
//for (let i = 0; i < mult3.push; i++) {
  //if (mult3[i] * 3 !==0) {
    //console.log(mult3[i] + 'fizz');
  //} else if (mult5[i] * 5 !==0) {
    //console.log(mult5[i] + 'buzz')
  //}
//} return
////console.log('========question9=========')
//let arrz = [1, 2, 3];
//const first2 = (num9) => {
  //for (let i = 3; i >= num9; i--) {
  //arrz.push(i);
//}
...
const testArry = [2,1,4,2,5,2,3,23,3,3,2,2,2,24,56,2,2,5,46,2];
console.log(`Mode of [${testArry}] is ${mode(testArry)}.`);
...
console.log('============questin13============');
let arry12 = [1, 4, 6, 9, 10];
let total = 0;
for (let i in arry12) { total += arry12[i]; }
